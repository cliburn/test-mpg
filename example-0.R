...
data.1 = read.csv("data/EQAPOL_101_EP4_K69038GP_Unstim_02064.csv",  header = TRUE)
data.2 = read.csv("data/EQAPOL_101_EP4_K69038GP_CEF_02072.csv",  header = TRUE)
data.3 = read.csv("data/EQAPOL_101_EP4_K69038GP_CMVpp65_02069.csv",  header = TRUE)
